...
<body>
    ...
    <form class="form-signin" method="post" action="login.php">
      ...
      <input type="text" class="form-control" name="r_lname" placeholder="Username" required="" autofocus />
...
if(isset($_POST['login'])){
	...
	$select_user = "select * from receptionist where BINARY r_lname = BINARY '$r_lname' AND BINARY r_pass = BINARY '$r_pass'";
