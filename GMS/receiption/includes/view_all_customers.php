...
?>	
   ...
   <tr align="center">
	    ...
	    <td><a href="index.php?edit_customer=<?php echo $reg_no; ?>">Edit</a></td>
	    <td><a href="includes/delete_customer_details.php?delete_customer_details=<?php echo $reg_no; ?>"onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
  </tr>
