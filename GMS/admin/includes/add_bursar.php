...
<p style="text-align: center;"><strong><span style="text-decoration: underline;">BURSAR DETAILS:</span></strong></p>
	...
	<tr>		
		...
		<td><input type="text" name="b_fname" id="b_fname" size="35" class="text" placeholder="First Name" required=""/></td>		
	</tr>
	
	<tr>		
		<td align="right" bgcolor="#dbe5f1"><strong>Last Name:</strong></td>
		<td><input type="text" name="b_lname" id="b_lname" size="35" class="text" placeholder="Last Name" required=""/></td>
	</tr>
		
    <tr>		
		<td align="right" bgcolor="#dbe5f1"><strong>Phone Number:</strong></td>
		<td><input type="text" name="b_pno" id="b_pno" size="35"class="text" placeholder="Phone number" required=""/></td>		
	</tr>
	
	<tr>
	    <td align="right" bgcolor="#dbe5f1"><strong>Gender:</strong></td>		
		<td><input type="radio" name="b_gender" value="Male" > Male
        <input type="radio" name="b_gender" value="Female"> Female</td>	
	</tr>
		
	<tr>		
		<td align="right" bgcolor="#dbe5f1"><strong>Password:</strong></td>
		<td><input type="text" name="b_pass" id="b_pass" size="35" class="text" placeholder="Password" required=""/></td>		
	</tr>
...
if(isset($_POST['submit'])){
	...
	$query = mysqli_query($con, "insert into bursar 
	(b_fname, b_lname, b_pno, b_gender, b_pass)
	values
	('$b_fname', '$b_lname', '$b_pno', '$b_gender', '$b_pass') ");
