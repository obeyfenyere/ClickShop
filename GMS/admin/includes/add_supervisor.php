...
<p style="text-align: center;"><strong><span style="text-decoration: underline;">SUPERVISOR DETAILS:</span></strong></p>
	
	<tr>		
		<td align="right" bgcolor="#dbe5f1"><strong>First Name:</strong></td>
		<td><input type="text" name="s_fname" id="s_fname" size="35" class="text" placeholder="First Name" required=""/></td>		
	</tr>
	
	<tr>		
		<td align="right" bgcolor="#dbe5f1"><strong>Last Name:</strong></td>
		<td><input type="text" name="s_lname" id="s_lname" size="35" class="text" placeholder="Last Name" required=""/></td>
	</tr>
		
    <tr>		
		<td align="right" bgcolor="#dbe5f1"><strong>Phone Number:</strong></td>
		<td><input type="text" name="s_pno" id="s_pno" size="35"class="text" placeholder="Phone number" required=""/></td>		
	</tr>
	
	<tr>
	    <td align="right" bgcolor="#dbe5f1"><strong>Gender:</strong></td>		
		<td><input type="radio" name="s_gender" value="Male" > Male
        <input type="radio" name="s_gender" value="Female"> Female</td>	
	</tr>
		
	<tr>		
		<td align="right" bgcolor="#dbe5f1"><strong>Password:</strong></td>
		<td><input type="text" name="s_pass" id="s_pass" size="35" class="text" placeholder="Password" required=""/></td>		
	</tr>
...
if(isset($_POST['submit'])){
	...
	$query = mysqli_query($con, "insert into supervisor 
	(s_fname, s_lname, s_pno, s_gender, s_pass)
	values
	('$s_fname', '$s_lname', '$s_pno', '$s_gender', '$s_pass') ");
