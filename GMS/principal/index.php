...
<div class="wrapper">
	...
	<!--This is header-->
	<div class="header" align="center"><h1>TADIWA SYSTEM</h1><h2>(PRINCIPAL)</h2></div>
	<!--End of header-->
	...
	<br>
		...
		<button class="button" style="vertical-align: middle"><span><a href="index.php?view_all_customers">VIEW CUSTOMERS</a></span></button>
		 <button class="button" style="vertical-align: middle"><span><a href="#">VEHICLE PROGRESS</a></span></button>
	...
	<h3 style="color: #16365d; text-align: right;"> Hello  <?php echo ucwords($_SESSION['p_lname']); ?>! </h3>
